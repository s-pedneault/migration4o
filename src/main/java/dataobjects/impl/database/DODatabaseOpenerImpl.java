...
public class DODatabaseOpenerImpl implements DODatabaseOpener {
    ...
    public ExtObjectContainer openDatabase(String filePath) {
        ...
        DODatabaseEncoding[] encodingConfigs = {
                new DODatabaseEncodingImpl("UTF-8 (default)", true, true, true),
                new DODatabaseEncodingImpl("Latin-1 (legacy)", false, true, true),
                new DODatabaseEncodingImpl("UTF-8 no-intern", true, false, true),
                new DODatabaseEncodingImpl("Latin-1 no-intern", false, false, true),
                new DODatabaseEncodingImpl("UTF-8 no-dotnet", true, true, false),
                new DODatabaseEncodingImpl("Latin-1 no-dotnet", false, true, false)
        };
    ...
    private Configuration createDatabaseConfiguration(DODatabaseEncoding encodingConfig) throws Exception {
        ...
        config.reflectWith(new JdkReflector(DODatabaseOpenerImpl.class.getClassLoader()));
