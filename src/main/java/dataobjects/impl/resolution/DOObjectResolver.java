...
import dataobjects.impl.models.database.DOReferenceType;
import dataobjects.impl.models.database.DOCollectionReference;
import dataobjects.impl.engine.resolvers.DOGenericObjectResolver;
...
public class DOObjectResolver {
    ...
    public DODatabaseObject[] resolveAllObjects(ExtObjectContainer container,
            DODatabase database,
            DOSchema schema,
            dataobjects.impl.engine.DOEngine engine) {
    ...
    private DODatabaseObject resolveAndBuildObject(
        ...
        try {
            ...
            return new dataobjects.impl.models.database.DODatabaseObject(
                    objectId,
                    classDefinition,
                    allClasses,
                    directRefs,
