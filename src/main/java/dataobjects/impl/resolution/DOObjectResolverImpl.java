...
import dataobjects.impl.models.database.DOObjectReferenceImpl;
import dataobjects.impl.models.database.DOCollectionReferenceImpl;
import dataobjects.impl.engine.resolvers.DOGenericObjectResolverImpl;
 ...
 */
public class DOObjectResolverImpl implements DOObjectResolver {

    private final DOGenericObjectResolver genericObjectResolver = new DOGenericObjectResolverImpl();

    @Override
    public DODatabaseObject[] resolveAllObjects(ExtObjectContainer container,
            DODatabase database,
            DOSchema schema,
            dataobjects.api.engine.DOEngine engine) {
    ...
    private DODatabaseObject resolveAndBuildObject(
        ...
        try {
            ...
            return new dataobjects.impl.models.database.DODatabaseObjectImpl(
                    objectId,
                    classDefinition,
                    allClasses,
                    directRefs,
    ...
    private DOObjectReference[] extractDirectReferences(ExtObjectContainer container, Object obj,
        ...
        try {
                        ...
                        if ("mID".equals(fieldName) || "mId".equals(fieldName) ||
                            ...
                            if (mIdValue != null) {
                                ...
                                if (targetEntityId != null && targetEntityId > 0) {
                                    ...
                                    DOObjectReference syntheticRef = new DOObjectReferenceImpl(
            ...
            for (DOField field : fields) {
                ...
                if (refId != null) {
                    DOObjectReference ref = new DOObjectReferenceImpl(
        ...
        try {
            ...
            if (ObjectResolverUtil.isAnyCollectionType(obj)) {
                ...
                if (result != null) {
                    ...
                    DOField collectionField = new DOFieldImpl("collection_elements", "Collection elements",
                            collectionType, null, false, true, result.contentType, null);

                    DOCollectionReference collectionRef = new DOCollectionReferenceImpl(
