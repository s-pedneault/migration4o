package migration4o.engine.report.reachability;

import migration4o.engine.DOEngine;
import migration4o.engine.report.reachability.ReachabilityReportGenerator;
import migration4o.engine.report.reachability.data.DatabaseAnalyzer;
import migration4o.engine.report.reachability.data.SchemaAnalyzer;
import migration4o.engine.report.reachability.html.CSSStylesWriter;
import migration4o.engine.report.reachability.html.HTMLWriter;
import migration4o.engine.report.reachability.html.JavaScriptWriter;
...
public class ReachabilityReportGenerator {
    ...
    private void writePrimitiveFields(DODatabaseObject obj) throws IOException {
        try {
            ...
            java.util.Map<String, ObjectResolverUtil.PrimitiveFieldValue> fieldValues = ObjectResolverUtil
