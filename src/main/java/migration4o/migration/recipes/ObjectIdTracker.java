...
/**
 * Recipe for tracking exported object IDs and detecting duplicates.
 * Manages the deduplication set and statistics recording.
 */
public class ObjectIdTracker {

    /**
     * Records an object reference and returns whether it's a duplicate.
     * Root objects always pass through (not checked for duplicates).
     * 
    ...
    public static boolean shouldExport(
            ...
            Set<Long> exportedObjectIds,
            ExportStatistics statistics,
            Long parentObjectId,
            String sourceContainingClassName,
