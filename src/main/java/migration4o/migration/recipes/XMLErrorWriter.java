...
/**
 * Recipe for writing XML error markers.
 * Provides consistent error formatting in XML output for debugging.
 */
public class XMLErrorWriter {

    /**
     * Writes an XML comment indicating an export error.
     * Used to mark failures in the XML output while allowing export to continue.
     * 
     ...
     */
    public static void writeErrorMarker(XMLWriter xmlWriter, long objectId, String errorMsg, int indentLevel)
            throws IOException {
     ...
     * @throws IOException if write fails
     */
    public static void writeErrorMarker(XMLWriter xmlWriter, long objectId, Exception e, int indentLevel)
            throws IOException {
