...
public class DODatabaseField {
    ...
    public DODatabaseField() {
        this.isArray = false;
    }

    public DODatabaseField(String name, String typeName) {
        this();
        this.name = name;
        this.typeName = typeName;
    }

    public DODatabaseField(String name, String description, String typeName, DODatabaseClass typeClass,
            boolean isPrimitive,
            boolean isArray,
            String contentTypeName, DODatabaseClass contentTypeClass) {
        this.name = name;
