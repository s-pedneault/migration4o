...
/**
 * Unified utility for extracting collection items from DB4O objects.
...
public class CollectionUtil {
     ...
     */
    public static Collection<?> extractCollectionItems(ExtObjectContainer container, Object collectionObj) {
        ...
        if (collectionObj.getClass().isArray()) {
            ...
            return arrayToList(collectionObj);
        }
     ...
     */
    private static List<Object> arrayToList(Object arrayObj) {
        List<Object> list = new ArrayList<>();
