 ...
 * @param configDisplay        Export configuration summary for the welcome page; may be {@code null}.
 */
public record WelcomePageParams(Path dbRoot, String dbName, String navItemsJson, int moduleCount, int classCount, int objectCount, MunicipalityInfo municipality, List<OrganizationInfo> organizations, ExportConfigDisplay configDisplay) {
