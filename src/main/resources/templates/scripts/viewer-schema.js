...
// Convert DEMO_EXPORT ID arrays to Sets for O(1) lookup.
if (window.DEMO_EXPORT) {
    Object.keys(window.DEMO_EXPORT).forEach(function (k) {
        window.DEMO_EXPORT[k] = new Set(window.DEMO_EXPORT[k].map(String));
    });
}
